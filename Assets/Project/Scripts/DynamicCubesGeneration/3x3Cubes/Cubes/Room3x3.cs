...
#if UNITY_EDITOR
public class Room3x3 : MonoBehaviour
{
    public WallsList3.Wall selectedWall_1, selectedWall_2, selectedWall_3, selectedWall_4;
    ...
    private void OnValidate()
    {
        if (showFields)
        {
            selectedWall_1 = (WallsList3.Wall)EditorGUILayout.EnumPopup("Select a wall:", selectedWall_1);
            selectedWall_2 = (WallsList3.Wall)EditorGUILayout.EnumPopup("Select a wall:", selectedWall_2);
            selectedWall_3 = (WallsList3.Wall)EditorGUILayout.EnumPopup("Select a wall:", selectedWall_3);
            selectedWall_4 = (WallsList3.Wall)EditorGUILayout.EnumPopup("Select a wall:", selectedWall_4);

            WallsList3 walls = gameObject.GetComponentInParent<WallsList3>();
    ...
    [CustomEditor(typeof(Room3x3))]
    public class DeadEndEditor : Editor
    {
        public override void OnInspectorGUI()
        {
            Room3x3 script = (Room3x3)target;
