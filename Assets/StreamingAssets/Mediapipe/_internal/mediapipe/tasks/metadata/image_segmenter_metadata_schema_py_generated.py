...
def ImageSegmenterOptionsStart(builder): builder.StartObject(2)
def ImageSegmenterOptionsAddActivation(builder, activation): builder.PrependInt8Slot(0, activation, 0)
def ImageSegmenterOptionsAddMinParserVersion(builder, minParserVersion): builder.PrependUOffsetTRelativeSlot(1, flatbuffers.number_types.UOffsetTFlags.py_type(minParserVersion), 0)
def ImageSegmenterOptionsEnd(builder): return builder.EndObject()
