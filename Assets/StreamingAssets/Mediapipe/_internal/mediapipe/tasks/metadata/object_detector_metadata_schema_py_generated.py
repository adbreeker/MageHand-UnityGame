...
def FixedAnchorStart(builder): builder.StartObject(4)
def FixedAnchorAddXCenter(builder, xCenter): builder.PrependFloat32Slot(0, xCenter, 0.0)
def FixedAnchorAddYCenter(builder, yCenter): builder.PrependFloat32Slot(1, yCenter, 0.0)
def FixedAnchorAddWidth(builder, width): builder.PrependFloat32Slot(2, width, 0.0)
def FixedAnchorAddHeight(builder, height): builder.PrependFloat32Slot(3, height, 0.0)
def FixedAnchorEnd(builder): return builder.EndObject()
...
def FixedAnchorsSchemaStart(builder): builder.StartObject(1)
def FixedAnchorsSchemaAddAnchors(builder, anchors): builder.PrependUOffsetTRelativeSlot(0, flatbuffers.number_types.UOffsetTFlags.py_type(anchors), 0)
def FixedAnchorsSchemaStartAnchorsVector(builder, numElems): return builder.StartVector(4, numElems, 4)
def FixedAnchorsSchemaEnd(builder): return builder.EndObject()
...
def SsdAnchorsOptionsStart(builder): builder.StartObject(1)
def SsdAnchorsOptionsAddFixedAnchorsSchema(builder, fixedAnchorsSchema): builder.PrependUOffsetTRelativeSlot(0, flatbuffers.number_types.UOffsetTFlags.py_type(fixedAnchorsSchema), 0)
def SsdAnchorsOptionsEnd(builder): return builder.EndObject()
...
def TensorsDecodingOptionsStart(builder): builder.StartObject(12)
def TensorsDecodingOptionsAddNumClasses(builder, numClasses): builder.PrependInt32Slot(0, numClasses, 0)
def TensorsDecodingOptionsAddNumBoxes(builder, numBoxes): builder.PrependInt32Slot(1, numBoxes, 0)
def TensorsDecodingOptionsAddNumCoords(builder, numCoords): builder.PrependInt32Slot(2, numCoords, 0)
def TensorsDecodingOptionsAddKeypointCoordOffset(builder, keypointCoordOffset): builder.PrependInt32Slot(3, keypointCoordOffset, 0)
def TensorsDecodingOptionsAddNumKeypoints(builder, numKeypoints): builder.PrependInt32Slot(4, numKeypoints, 0)
def TensorsDecodingOptionsAddNumValuesPerKeypoint(builder, numValuesPerKeypoint): builder.PrependInt32Slot(5, numValuesPerKeypoint, 0)
def TensorsDecodingOptionsAddXScale(builder, xScale): builder.PrependFloat32Slot(6, xScale, 0.0)
def TensorsDecodingOptionsAddYScale(builder, yScale): builder.PrependFloat32Slot(7, yScale, 0.0)
def TensorsDecodingOptionsAddWScale(builder, wScale): builder.PrependFloat32Slot(8, wScale, 0.0)
def TensorsDecodingOptionsAddHScale(builder, hScale): builder.PrependFloat32Slot(9, hScale, 0.0)
def TensorsDecodingOptionsAddApplyExponentialOnBoxSize(builder, applyExponentialOnBoxSize): builder.PrependBoolSlot(10, applyExponentialOnBoxSize, 0)
def TensorsDecodingOptionsAddSigmoidScore(builder, sigmoidScore): builder.PrependBoolSlot(11, sigmoidScore, 0)
def TensorsDecodingOptionsEnd(builder): return builder.EndObject()
...
def ObjectDetectorOptionsStart(builder): builder.StartObject(3)
def ObjectDetectorOptionsAddMinParserVersion(builder, minParserVersion): builder.PrependUOffsetTRelativeSlot(0, flatbuffers.number_types.UOffsetTFlags.py_type(minParserVersion), 0)
def ObjectDetectorOptionsAddSsdAnchorsOptions(builder, ssdAnchorsOptions): builder.PrependUOffsetTRelativeSlot(1, flatbuffers.number_types.UOffsetTFlags.py_type(ssdAnchorsOptions), 0)
def ObjectDetectorOptionsAddTensorsDecodingOptions(builder, tensorsDecodingOptions): builder.PrependUOffsetTRelativeSlot(2, flatbuffers.number_types.UOffsetTFlags.py_type(tensorsDecodingOptions), 0)
def ObjectDetectorOptionsEnd(builder): return builder.EndObject()
